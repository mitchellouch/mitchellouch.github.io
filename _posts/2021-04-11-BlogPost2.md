...
Unless something has gone terribly wrong, we should have the ability to add and delete seeds from our cloud database! We can also use `router.patch()` for updating database entries, but let’s just leave it at deleting.
