...
##### Step 4: Hello World! 
You might be thinking: "Isn't this supposed to be a blog about NodeJS? I just spent an eternity reading about a bunch of JavaScript stuff, where's the Node at?" Not to worry, dear reader. The time has come for use to create our very first NodeJS app! If you want to make one as well, head over to 
