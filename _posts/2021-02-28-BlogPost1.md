...
##### Step 4: Hello World! 
You might be thinking: "Isn't this supposed to be a blog about NodeJS? I just spent an eternity reading about a bunch of JavaScript stuff, where's the Node at?" Not to worry, the time has come for us to create an extremely cool Hello World app and run it in the NodeJS environment! If you want to make one as well, start by downloading NodeJS from the [official website](https://nodejs.org/en/download/). I've spent so much time on there lately, Netflix is no longer the first thing to come up when I type "n" in Chrome...

![alt text.](https://i.imgur.com/9Yi5xTL.png "nodelogo")
